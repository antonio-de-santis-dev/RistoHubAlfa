...
import { sampleWithRequiredData } from '../lista-contatti.test-samples';
...
describe('ListaContatti Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.listaContattis()[0]).toEqual(expect.objectContaining({ id: 9791 }));
  });

  describe('trackId', () => {
    it('should forward to listaContattiService', () => {
      const entity = { id: 9791 };
      jest.spyOn(service, 'getListaContattiIdentifier');
      const id = comp.trackId(entity);
      expect(service.getListaContattiIdentifier).toHaveBeenCalledWith(entity);
