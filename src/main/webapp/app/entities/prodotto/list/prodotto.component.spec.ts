...
import { sampleWithRequiredData } from '../prodotto.test-samples';
...
describe('Prodotto Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.prodottos()[0]).toEqual(expect.objectContaining({ id: 544 }));
  });

  describe('trackId', () => {
    it('should forward to prodottoService', () => {
      const entity = { id: 544 };
      jest.spyOn(service, 'getProdottoIdentifier');
      const id = comp.trackId(entity);
      expect(service.getProdottoIdentifier).toHaveBeenCalledWith(entity);
