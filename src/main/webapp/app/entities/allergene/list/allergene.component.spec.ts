...
import { sampleWithRequiredData } from '../allergene.test-samples';
...
describe('Allergene Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.allergenes()[0]).toEqual(expect.objectContaining({ id: 7644 }));
  });

  describe('trackId', () => {
    it('should forward to allergeneService', () => {
      const entity = { id: 7644 };
      jest.spyOn(service, 'getAllergeneIdentifier');
      const id = comp.trackId(entity);
      expect(service.getAllergeneIdentifier).toHaveBeenCalledWith(entity);
