...
class MenuResourceIT {
    ...
    private static final String DEFAULT_LOGO_NOME = "AAAAAAAAAA";
    private static final String UPDATED_LOGO_NOME = "BBBBBBBBBB";
    ...
    void getAllMenus() throws Exception {
        ...
        restMenuMockMvc
            ...
            .andExpect(jsonPath("$.[*].logoNome").value(hasItem(DEFAULT_LOGO_NOME)));
    }
    ...
    void getMenu() throws Exception {
        ...
        restMenuMockMvc
            ...
            .andExpect(jsonPath("$.logoNome").value(DEFAULT_LOGO_NOME));
    }
    ...
    void partialUpdateMenuWithPatch() throws Exception {
        ...
        partialUpdatedMenu.attivo(UPDATED_ATTIVO).logo(UPDATED_LOGO).logoContentType(UPDATED_LOGO_CONTENT_TYPE);
